...
I'm Charlie, recent Computer Science graduate from the University of California, Irvine

Currently I'm
- working on PeterPortal Client (check my top pinned project!)
- looking for full-time SWE positions
- producing music of all genres
